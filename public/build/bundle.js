    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t = text(/*error*/ ctx[6]);
    			attr_dev(p, "class", "svelte-thjx9b");
    			add_location(p, file, 116, 1, 4311);
    			attr_dev(div, "id", "error-indicator");
    			attr_dev(div, "class", "svelte-thjx9b");
    			add_location(div, file, 115, 2, 4214);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-thjx9b");
    			add_location(h1, file, 71, 1, 1840);
    			attr_dev(p0, "class", "svelte-thjx9b");
    			add_location(p0, file, 72, 1, 1867);
    			attr_dev(label0, "for", "wiggle-text");
    			attr_dev(label0, "class", "svelte-thjx9b");
    			add_location(label0, file, 77, 6, 2051);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "name", "wiggle-rate");
    			attr_dev(input0, "id", "wiggle-rate");
    			attr_dev(input0, "class", "svelte-thjx9b");
    			add_location(input0, file, 78, 6, 2102);
    			attr_dev(span0, "class", "tooltip svelte-thjx9b");
    			add_location(span0, file, 79, 6, 2188);
    			attr_dev(div0, "id", "wiggle-rate-wrapper");
    			attr_dev(div0, "class", "wrapper svelte-thjx9b");
    			add_location(div0, file, 76, 5, 1998);
    			attr_dev(div1, "class", "split svelte-thjx9b");
    			add_location(div1, file, 75, 4, 1973);
    			attr_dev(label1, "for", "line-length");
    			attr_dev(label1, "class", "svelte-thjx9b");
    			add_location(label1, file, 84, 6, 2338);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "name", "line-length");
    			attr_dev(input1, "id", "line-length");
    			attr_dev(input1, "class", "svelte-thjx9b");
    			add_location(input1, file, 85, 6, 2389);
    			attr_dev(span1, "class", "tooltip svelte-thjx9b");
    			add_location(span1, file, 86, 6, 2475);
    			attr_dev(div2, "id", "line-length-wrapper");
    			attr_dev(div2, "class", "wrapper svelte-thjx9b");
    			add_location(div2, file, 83, 5, 2285);
    			attr_dev(div3, "class", "split svelte-thjx9b");
    			add_location(div3, file, 82, 4, 2260);
    			attr_dev(label2, "for", "line-count");
    			attr_dev(label2, "class", "svelte-thjx9b");
    			add_location(label2, file, 91, 6, 2633);
    			attr_dev(input2, "type", "Text");
    			attr_dev(input2, "name", "line-count");
    			attr_dev(input2, "id", "line-count");
    			attr_dev(input2, "class", "svelte-thjx9b");
    			add_location(input2, file, 92, 6, 2682);
    			attr_dev(span2, "class", "tooltip svelte-thjx9b");
    			add_location(span2, file, 93, 6, 2765);
    			attr_dev(div4, "id", "line-count-wrapper");
    			attr_dev(div4, "class", "wrapper svelte-thjx9b");
    			add_location(div4, file, 90, 5, 2581);
    			attr_dev(div5, "class", "split svelte-thjx9b");
    			add_location(div5, file, 89, 4, 2556);
    			attr_dev(div6, "class", "row svelte-thjx9b");
    			add_location(div6, file, 74, 3, 1951);
    			attr_dev(input3, "type", "text");
    			attr_dev(input3, "name", "wiggle-text");
    			attr_dev(input3, "id", "wiggle-text");
    			attr_dev(input3, "placeholder", "wiggle");
    			attr_dev(input3, "class", "svelte-thjx9b");
    			add_location(input3, file, 98, 3, 2889);
    			attr_dev(div7, "id", "text-wrapper");
    			attr_dev(div7, "class", "svelte-thjx9b");
    			add_location(div7, file, 97, 2, 2862);
    			attr_dev(div8, "id", "input-options");
    			attr_dev(div8, "class", "svelte-thjx9b");
    			add_location(div8, file, 73, 1, 1923);
    			attr_dev(button0, "type", "button");
    			attr_dev(button0, "name", "button");
    			attr_dev(button0, "id", "copy-button");
    			attr_dev(button0, "class", "svelte-thjx9b");
    			add_location(button0, file, 101, 1, 3002);
    			attr_dev(p1, "id", "output");
    			attr_dev(p1, "contenteditable", "false");
    			attr_dev(p1, "class", "svelte-thjx9b");
    			add_location(p1, file, 103, 2, 3132);
    			attr_dev(div9, "id", "output-wrapper");
    			attr_dev(div9, "class", "svelte-thjx9b");
    			add_location(div9, file, 102, 1, 3104);
    			attr_dev(textarea, "id", "copy-area");
    			attr_dev(textarea, "class", "i-not-exists svelte-thjx9b");
    			textarea.value = /*output*/ ctx[4];
    			add_location(textarea, file, 106, 1, 3195);
    			attr_dev(a, "href", "https://github.com/arj101/wiggle-generator-web");
    			attr_dev(a, "class", "svelte-thjx9b");
    			add_location(a, file, 107, 1, 3262);
    			attr_dev(main, "class", "svelte-thjx9b");
    			add_location(main, file, 70, 0, 1832);
    			attr_dev(rect, "fill", "none");
    			attr_dev(rect, "height", "24");
    			attr_dev(rect, "width", "24");
    			attr_dev(rect, "class", "svelte-thjx9b");
    			add_location(rect, file, 111, 140, 3579);
    			attr_dev(g0, "class", "svelte-thjx9b");
    			add_location(g0, file, 111, 137, 3576);
    			...
    			attr_dev(path, "class", "svelte-thjx9b");
    			add_location(path, file, 111, 198, 3637);
    			attr_dev(circle0, "cx", "6.5");
    			attr_dev(circle0, "cy", "11.5");
    			attr_dev(circle0, "r", "1.5");
    			attr_dev(circle0, "class", "svelte-thjx9b");
    			add_location(circle0, file, 111, 583, 4022);
    			attr_dev(circle1, "cx", "9.5");
    			attr_dev(circle1, "cy", "7.5");
    			attr_dev(circle1, "r", "1.5");
    			attr_dev(circle1, "class", "svelte-thjx9b");
    			add_location(circle1, file, 111, 619, 4058);
    			attr_dev(circle2, "cx", "14.5");
    			attr_dev(circle2, "cy", "7.5");
    			attr_dev(circle2, "r", "1.5");
    			attr_dev(circle2, "class", "svelte-thjx9b");
    			add_location(circle2, file, 111, 654, 4093);
    			attr_dev(circle3, "cx", "17.5");
    			attr_dev(circle3, "cy", "11.5");
    			attr_dev(circle3, "r", "1.5");
    			attr_dev(circle3, "class", "svelte-thjx9b");
    			add_location(circle3, file, 111, 690, 4129);
    			attr_dev(g1, "class", "svelte-thjx9b");
    			add_location(g1, file, 111, 195, 3634);
    			attr_dev(g2, "class", "svelte-thjx9b");
    			add_location(g2, file, 111, 192, 3631);
    			attr_dev(g3, "class", "svelte-thjx9b");
    			add_location(g3, file, 111, 189, 3628);
    			attr_dev(g4, "class", "svelte-thjx9b");
    			add_location(g4, file, 111, 186, 3625);
    			...
    			attr_dev(svg, "class", "svelte-thjx9b");
    			add_location(svg, file, 111, 1, 3440);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "name", "button");
    			attr_dev(button1, "id", "theme-switcher");
    			attr_dev(button1, "class", "svelte-thjx9b");
    			add_location(button1, file, 110, 0, 3359);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button1, "click", changeTheme, false, false, false)
    				];
